<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="UserOrder(Cash).aspx.cs" Inherits="UserOrder_Cash_" %>
        ...
        <asp:Panel ID="Panel3" runat="server" BackColor="White" CssClass="auto-style32" Height="612px" Width="1380px">
            ...
            <asp:Panel ID="Panel4" runat="server">
                <div class="auto-style34">
                    <strong class="newStyle6">User Order(By Cash)</strong></div>
            </asp:Panel>
            <br />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OnlineDeliveryServer %>" SelectCommand="SELECT [OrderID], [ProductName], [quantity], [dateoforder], [address], [mobilenumber] FROM [OrderDetails3] ORDER BY [dateoforder] DESC"></asp:SqlDataSource>
        </asp:Panel>
    </asp:Panel>
</asp:Content>
